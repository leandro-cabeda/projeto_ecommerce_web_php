		...
		<div class="row">
			...
			<div class="container marketing">
				<div class="col-xs-12 col-sm-12 col-md-12" style="border-bottom:2px solid black; text-transform: uppercase; padding:4px; padding-left: 20px;background-color:#11D400; margin-bottom:40px;">
					<h1 class="col-xs-12 col-sm-12 col-md-12 text-center" style="color:black; font-weight:600;">Sobre a Empresa</h1>
				</div>

			<div class="row" style="margin-bottom:50px;">
				<div class="col-xs-5 col-md-5">
					<h1 class="text-center" style="color:black;font-weight:600;">Histórico</h1>
						<p style="color:black;text-indent: 2em" class="text-justify">
							Fundado no ano de 2003, a GLM é um dos pioneiros no comércio eletrônico brasileiro e hoje está entre as maiores Empresas deste mercado na América Latina, sendo a maior referência brasileira do varejo on-line no segmento especializado de Informática e Eletrônicos. Esta performance é resultado de uma empresa obcecada por agilidade, qualidade de atendimento, velocidade de entrega e respeito pelo consumidor. Prova disso, a GLM! possui todos os mais altos índices de avaliação e selos de qualidade existentes da internet no Brasil. A empresa está ranqueada entre os 120 websites mais acessados do Brasil.
						</p>
						<p style="color:black;text-indent: 2em" class="text-justify">
							Desde sua fundação, a GLM! já atendeu mais de dois milhões de clientes, entre pessoas e empresas - Além disso, a GLM! já realizou entregas em mais de 5.000 cidades diferentes do Brasil. Entre empresas clientes, podemos destacar grandes grupos como Microsoft, Banco Bradesco, Banco Itaú, Petrobrás, Exxon, Walt Disney, Ford, Rede Globo, Volvo, Exército do Brasil e vários orgãos do Governo Brasileiro.
						</p>
				</div>
